                        ...
                        <?php if ($tipo_usuario == 1) { ?>
                            ...
                            <div class="collapse" id="collapseGestionhg" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="layout-static.html">Contratos</a>
                                </nav>
                            </div>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Material Grafico</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Usa nuestras plantillas predeterminadas para poder acelerar
                            el proceso de crecimiento dentro de Horus Global, descarga y usa las plantillas que mas te
                            agraden.</li>
                    </ol>
