...
//CONEXIONES Y REQUERIMIENTOS DE LIBRERIAS 
...
//VERIFICACION DE SESION ACTIVA DEL USUSARIO
...
//FINAL DE VERIFICACION DE USUARIO 
/////////////////////////////////////////



// Configurar la API Key y el Secret Key
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="stylemontos.css">
</head>
...
<body class="sb-nav-fixed">
  ...
  <div class="card">
    <img src="imagenes/mas-fondos.jpg" alt="Servicio 1">
    <h2>$ 100.00 USDT</h2>
    <a <?php
$cargo = new Charge([
    'name' => 'Acceso al area premium',
    'description' => 'Se tiene acceso a los servicios',
    ...
    'metadata' => [
      ...
      try {
        ...
        ?> href="<?php echo $cargo->hosted_url;} catch (Exception $ex) { echo $ex->getMessage(); } ?>" class="btn">Incrementar Fondos</a>
  </div>

  <!--SEGUNDO SERVICIO DE INCREMENTO DE FONDOS -->
  <div class="card">
    <img src="imagenes/mas-fondos.jpg" alt="Servicio 2">
    <h2>$ 500.00 USDT</h2>
    <a <?php
    $cargo2 = new Charge([
    'name' => 'Acceso al area premium',
    ...
    'metadata' => [
      ...
      try {
        ...
        ?> href="<?php echo $cargo2->hosted_url;} catch (Exception $ex) { echo $ex->getMessage(); } ?>" class="btn">Incrementar Fondos</a>
  </div>

  <!-- TERCER SERVICIO DE INCREMENTO DE FONDOS -->

  <div class="card">
    <img src="imagenes/mas-fondos.jpg" alt="Servicio 3">
    <h2>$ 1000.00 USDT</h2>
    <a <?php
    $cargo3 = new Charge([
    'name' => 'Acceso al area premium',
    ...
    'metadata' => [
      ...
      try {
        ...
        ?> href="<?php echo $cargo3->hosted_url;} catch (Exception $ex) { echo $ex->getMessage(); } ?>" class="btn">Incrementar Fondos</a>
  </div>
...
<!--ACA COMIENZA LA EDICION-->


        <!--<h1>Pago</h1>
	<p>El monto a pagar es: ?php echo $_POST["monto"] + 5; ?> USD</p>
	<form action="procesar_pago.php" method="post">
		<input type="hidden" id="monto_total" name="monto_total" value="?php echo $_POST["monto"] + 5; ?>">
